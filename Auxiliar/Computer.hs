...
secuenciaVertical :: Int -> Int -> [[Int]] -> Int
...
--   i: Jugador (1 o 2) cuyo estado se analiza.
--   b: Tablero representado como una lista de columnas.
secuenciaHorizontal :: Int -> Int -> [[Int]] -> Int
secuenciaHorizontal n i = secuenciaVertical n i . transpose

-- | Cuenta secuencias diagonales (de arriba izquierda a abajo derecha).
--   n: Longitud de la secuencia objetivo.
--   i: Jugador (1 o 2) cuyo estado se analiza.
--   b: Tablero representado como una lista de columnas.
secuenciaDiagonal1 :: Int -> Int -> [[Int]] -> Int
secuenciaDiagonal1 n i = secuenciaVertical n i . diagonals

-- | Cuenta secuencias diagonales (de abajo izquierda a arriba derecha).
--   n: Longitud de la secuencia objetivo.
--   i: Jugador (1 o 2) cuyo estado se analiza.
--   b: Tablero representado como una lista de columnas.
secuenciaDiagonal2 :: Int -> Int -> [[Int]] -> Int
secuenciaDiagonal2 n i = secuenciaVertical n i . diagonals . reverse

-- | Cuenta todas las secuencias de longitud n del jugador i en el tablero.
--   n: Longitud de la secuencia objetivo.
--   i: Jugador (1 o 2) cuyo estado se analiza.
--   b: Tablero representado como una lista de columnas.
secuencia :: Int -> Int -> [[Int]] -> Int
...
generalArbol :: Int -> Int -> [[Int]] -> Arbol [[Int]]
generalArbol i 0 b = Nodo b []
generalArbol i d b = Nodo b [generalArbol (3-i) (d-1) (place i x b) | x <- [0..6], not $ isLineFull (b !! x)]
...
obtenerCoeficientes :: Int -> Arbol [[Int]] -> Arbol Int
...
jugarIA :: Int -> [[Int]] -> [[Int]]
jugarIA d b
  | contarPiezasJug1 b == 1 = place 2 3 b -- Heuristica inicial
  | otherwise      = pos
    where
